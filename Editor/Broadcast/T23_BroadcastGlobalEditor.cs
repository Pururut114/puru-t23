...
namespace Trigger2to3
{
    ...
    internal class T23_BroadcastGlobalEditor : T23_BroadcastEditorBase
    {
        ...
        protected override void DrawFields()
        {
            ...
            {
                EditorGUILayout.HelpBox("BroadcastGlobal поддерживает только группы #0–#9.", MessageType.Error);
            }

            EditorGUILayout.PropertyField(serializedObject.FindProperty("sendTarget"));
            serializedObject.FindProperty("useablePlayer").intValue = (int)(UsablePlayer)EditorGUILayout.EnumPopup("Доступно для", (UsablePlayer)body.useablePlayer);
            serializedObject.FindProperty("bufferType").intValue = (int)(BufferType)EditorGUILayout.EnumPopup("Тип буфера", (BufferType)body.bufferType);
            ...
            else
            {
                ...
                if (body.commonBuffer == null)
                {
                    ...
                    if (GUILayout.Button("Добавить CommonBuffer", buttonStyle))
                    {
                ...
                if (body.commonBuffer == null)
                {
                    ...
                    {
                        EditorGUILayout.HelpBox("Укажите CommonBuffer.", MessageType.Warning);
                    }
                    else
                    {
