...
namespace Trigger2to3
{
    ...
    internal class T23_AudioBankEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            serializedObject.FindProperty("playbackOrder").intValue = (int)(Order)EditorGUILayout.EnumPopup("Порядок воспроизведения", (Order)body.playbackOrder);
            serializedObject.FindProperty("playbackStyle").intValue = (int)(Style)EditorGUILayout.EnumPopup("Стиль воспроизведения", (Style)body.playbackStyle);
