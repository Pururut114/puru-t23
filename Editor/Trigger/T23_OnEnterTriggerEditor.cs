...
namespace Trigger2to3
{
    ...
    internal class T23_OnEnterTriggerEditor : T23_TriggerEditorBase
    {
        protected override void DrawFields()
        {
            ...
            var includeLocalPlayer = EditorGUILayout.Toggle("Локальный игрок", layers.intValue == (layers.intValue | 1 << LayerMask.NameToLayer("PlayerLocal")));
            ...
            EditorGUI.BeginChangeCheck();
            var includePlayer = EditorGUILayout.Toggle("Удалённый игрок", layers.intValue == (layers.intValue | 1 << LayerMask.NameToLayer("Player")));
            if (EditorGUI.EndChangeCheck())
            {
