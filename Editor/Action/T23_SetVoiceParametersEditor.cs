...
namespace Trigger2to3
{
    ...
    internal class T23_SetVoiceParametersEditor : T23_ActionEditorBase
    {
        ...
        protected override void DrawFields()
        {
            ...
            triggeredPlayer_prop.boolValue = (TargetPlayer)EditorGUILayout.EnumPopup("Целевой игрок", (TargetPlayer)System.Convert.ToInt32(triggeredPlayer_prop.boolValue)) == TargetPlayer.TriggeredPlayer;
            if (triggeredPlayer_prop.boolValue) { EditorGUILayout.HelpBox("TriggeredPlayer определяется только для локальных Trigger-ов.", MessageType.Info); }
