...
namespace Trigger2to3
{
    ...
    internal class T23_AudioPauseEditor : T23_ActionEditorBase
    {
        ...
        protected override void DrawFields()
        {
            ...
            operation_prop.boolValue = (PauseOperation)EditorGUILayout.EnumPopup("Операция", (PauseOperation)System.Convert.ToInt32(operation_prop.boolValue)) == PauseOperation.Pause;
        }
    }
}
#endif
