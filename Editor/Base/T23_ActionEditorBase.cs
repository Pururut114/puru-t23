...
namespace Trigger2to3
{
    public class T23_ActionEditorBase : T23_ModuleEditorBase
    {
        ...
        protected override void DrawActionHeadder()
        {
            ...
            {
                body_base.priority = EditorGUILayout.IntField("Приоритет", body_base.priority);
            }
        }
        ...
        private void ToggleOperationField(SerializedProperty toggle_prop, SerializedProperty operation_prop)
        {
            ...
            ToggleOperation operation = (ToggleOperation)EditorGUILayout.EnumPopup("Операция", GetToggleOperation(toggle_prop, operation_prop));
        ...
        {
            PropertyBoxField("operation", "propertyBox", "usePropertyBox", () => serializedObject.FindProperty("operation").boolValue = (BoolOperation)EditorGUILayout.EnumPopup("Операция", (BoolOperation)System.Convert.ToInt32(serializedObject.FindProperty("operation").boolValue)) == BoolOperation.True);
        }
        ...
        protected void PropertyBoxField(string constFieldName, string propertyBoxFieldName, string switchFieldName, Action edit = null)
        {
            ...
            string buttonLabel = switchField.boolValue ? "Константа" : "PropertyBox";
